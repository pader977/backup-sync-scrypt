...
Se comprime una serie de carpetas o archivos en .tar.gz
Se utiliza Safe Copy Protocol / SCP con certificados para enviar el archivo comprimido a una máquina externa, ya sea un NAS u otro equipo
Se utiliza un API de Dropbox para sincronizar mediante un curl a nuestra nube
Se borran las copias que lleven más de una semana para no saturar el servidor de copias de seguridad
